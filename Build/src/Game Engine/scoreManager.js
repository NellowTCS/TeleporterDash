...
export const ScoreManager = {
  ...
  getLevelStats(filename) {
    return (
      this.scores.levels.get(filename) || {
        bestTime: Infinity,
        bestJumps: Infinity,
        lowestDeaths: Infinity,
        perfectRuns: 0,
  ...
  updateScoreboardUI(filename) {
    ...
    title.style.cssText =
      "margin: 0 0 15px 0; color: #00ff00; text-shadow: 0 0 10px rgba(0, 255, 0, 0.5);";
    ...
    bestStatsDiv.innerHTML = `
            ...
            <div style="margin-bottom: 8px; display: flex; justify-content: space-between;">
                ...
                <span style="color: #00ff00;">${
                  stats.bestJumps === Infinity ? "--" : stats.bestJumps
                }</span>
            </div>
            <div style="margin-bottom: 8px; display: flex; justify-content: space-between;">
                <span>Lowest Deaths:</span>
                <span style="color: #00ff00;">${
                  stats.lowestDeaths === Infinity ? "--" : stats.lowestDeaths
                }</span>
            </div>
            <div style="margin-bottom: 8px; display: flex; justify-content: space-between;">
    ...
    totalStatsDiv.style.cssText =
      "background: rgba(0, 255, 0, 0.05); padding: 15px; border-radius: 10px;";
  ...
  updateMenuScoreboardUI() {
    ...
    if (levelIds.length === 0) {
      html +=
        '<div style="color: #aaa; text-align: center; padding: 20px;">No levels completed yet</div>';
    }
